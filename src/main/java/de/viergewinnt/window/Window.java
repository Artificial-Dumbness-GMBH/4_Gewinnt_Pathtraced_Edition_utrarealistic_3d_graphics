...
public class Window {
    ...
    public void create(Board board) {
        ...
        try {
            ...
            Game game = new Game();
            Board activeBoard = game.getBoard();
            ...
            try(PathTracer tracer=new PathTracer(Scene.fromBoard(activeBoard))) {
                while(!glfwWindowShouldClose(window)) {
                    ...
                    if(now-titleTime>=1) {
                        ...
                        String title=String.format(java.util.Locale.ROOT,"4 Gewinnt | %.1f FPS | %d spp | %s | WASD + rechte Maus | Tasten 1-7",frames/(now-titleTime),tracer.samples(),state);
