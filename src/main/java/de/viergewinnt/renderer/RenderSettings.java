...
public record RenderSettings(Denoiser denoiser,int bounces,int samplesPerFrame,
        int maxWidth,int maxHeight,float denoiseStrength,float exposure) {
    ...
    public RenderSettings systemOverrides() {
        ...
        return new RenderSettings(mode,Integer.getInteger("pt.bounces",bounces),Integer.getInteger("pt.samplesPerFrame",samplesPerFrame),
            ...
            Float.parseFloat(System.getProperty("pt.exposure",Float.toString(exposure))));
    }
    ...
    public RenderSettings withDenoiser(Denoiser v) { return new RenderSettings(v,bounces,samplesPerFrame,maxWidth,maxHeight,denoiseStrength,exposure); }
    public RenderSettings withBounces(int v) { return new RenderSettings(denoiser,v,samplesPerFrame,maxWidth,maxHeight,denoiseStrength,exposure); }
    public RenderSettings withSamples(int v) { return new RenderSettings(denoiser,bounces,v,maxWidth,maxHeight,denoiseStrength,exposure); }
    public RenderSettings withResolution(int w,int h) { return new RenderSettings(denoiser,bounces,samplesPerFrame,w,h,denoiseStrength,exposure); }
    public RenderSettings withStrength(float v) { return new RenderSettings(denoiser,bounces,samplesPerFrame,maxWidth,maxHeight,v,exposure); }
    public RenderSettings withExposure(float v) { return new RenderSettings(denoiser,bounces,samplesPerFrame,maxWidth,maxHeight,denoiseStrength,v); }
}
